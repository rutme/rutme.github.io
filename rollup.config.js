...
const template = `<html><head><meta charset="UTF-8"><link rel="icon" type="image/png" href="data:image/png;base64,${readFileSync('./tg.png').toString('base64')}"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="robots" content="noindex,nofollow"><title>Telegram</title><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"/></head><body><div class="wrapper"><div class="main animate__animated animate__fadeInDown"><h2 id="linkName" class="animate__animated animate__fadeInDown animate__delay-0.5s animate__fast"></h2><div class="animate__animated animate__fadeInDown animate__delay-0.8s animate__fast"> <a id="linkURL" href="#">Открыть</a> </div></div><h1> <a href="https://github.com/rutme/rutme.github.io" target="_blank" class="animate__animated animate__fadeInUp animate__delay-1s">rutme.github.io</a></h1></div></body></html>`;
